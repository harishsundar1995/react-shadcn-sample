        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600">
              Explore and interact with our collection of UI components. Try
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Visual elements for displaying information
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Components for showing progress and data
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <Alert>
                    ...
                    <AlertDescription>
                      This is an informational alert with some additional
                      details.
                    </AlertDescription>
                  </Alert>
